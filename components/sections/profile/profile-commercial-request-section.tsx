export default function CommercialRequestSection() {
    return (
        <section className='w-full flex items-center bg-white'>
            <div className='container mx-auto'>
                ...
                <p className='text-deepGray text-[20px] leading-[24px]'>
                    ...
                    gewerbliche Kunden an. Bitte füllen Sie das untenstehende
                    Formular aus, um einen Produktkatalog zu erhalten.
                </p>
            </div>
        </section>
    )
